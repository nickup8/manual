...
export default function TwoWireLeadSet({
    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="913" height="250" viewBox="0 0 913 250" fill="none">
            ...
            <path d="M828 20.5C665.5 20.5 599.5 109.5 442.5 129.53C285.5 149.561 217.5 230.5 85.5 230.5" stroke="black" strokeWidth="20" />
            <path d="M85.5 20.5H828" stroke="white" strokeWidth="8" />
            <path d="M828 20.5C665.5 20.5 599.5 109.5 442.5 129.53C285.5 149.561 217.5 230.5 85.5 230.5" stroke="white" strokeWidth="8" />
            {terminalOne && (
                <>
